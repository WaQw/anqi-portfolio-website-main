  ...
  return (
    <section className="my-8 flex flex-col items-center justify-center">
      <h1 className="mb-4 text-[1.4rem] md:text-[2rem]">
        <MotionText delayOffset={0}>Hi, I'm Anqi Wang!</MotionText>
      </h1>
      ...
      <h1>
        <MotionDiv delayOffset={0.8}>I'm a Software Engineer 👩🏻‍💻</MotionDiv>
      </h1>
      {/* <h1>
        <MotionDiv delayOffset={1}>Web & APP Developer</MotionDiv>
      </h1> */}
